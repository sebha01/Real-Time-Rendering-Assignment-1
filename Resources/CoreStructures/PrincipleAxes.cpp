...
PrincipleAxes::PrincipleAxes() {
	...
	GLSL_ERROR glsl_err = ShaderLoader::createShaderProgram(string("..\\..\\Resources\\CoreStructures\\shaders\\basic_shader.vert"), string("..\\..\\Resources\\CoreStructures\\Shaders\\basic_shader.frag"), &paShader);
